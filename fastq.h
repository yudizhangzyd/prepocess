...
struct _fastq_data {
	...
	unsigned char *name_lengths;	/*!< lengths of names (assumes < 256) */
...
int write_fastq_marked_trimmed(fastq_data *fqd, fastq_options *fqo, unsigned int *id, unsigned int selected_id, int (*trim)(fastq_data *, char_t *, char_t *, unsigned int, void *), void *obj);
