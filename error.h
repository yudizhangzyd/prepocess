 ...
 */
#define MESSAGE(wp, type, err, ...) ((wp) ? wmessage((wp), __FILE__, __func__, __LINE__, (type), (err), __VA_ARGS__) : message(stderr, __FILE__, __func__, __LINE__, (type), (err), __VA_ARGS__))
#define MESSAGE_CONT(wp, ...) ((wp) ? wprintw((wp), __VA_ARGS__) : fprintf(stderr, __VA_ARGS__))
#endif 
